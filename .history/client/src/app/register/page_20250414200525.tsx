...
export default function Register(){
    ...
    return(
        <div className="h-full flex justify-center items-center">
            <form className="rounded-xl my-20 border border-black w-[60%] h-full flex  flex-col gap-3">
                ...
                <button className="border border-black rounded-lg h-8 w-32" type="submit">Register</button>
