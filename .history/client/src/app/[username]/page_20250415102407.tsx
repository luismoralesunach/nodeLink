...
export default function UserPage({ possibleUsername, possibleProfile }: UserPageProps) {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      if (possibleProfile) return // Don't fetch if already passed in
  ...
  return (
    <div style={{ backgroundColor: profile.background_color }} className="h-1w-full max-w-xl mx-auto py-10 px-6">
