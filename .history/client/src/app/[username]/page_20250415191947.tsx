  ...
  return (
    ...
    />
     ...
     {profile.links.map((link:any)=>(
        <a 
        style={{ color: profile.links_color}}
        key={link.id} href={link.url} target="_blank" rel="noopener noreferrer" className="w-full flex justify-center items-center font-semibold py-2 px-4 rounded mt-2 mb-2">
          {link.title}
        </a>
     ))}
