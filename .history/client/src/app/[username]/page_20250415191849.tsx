  ...
  return (
    ...
    />
     ...
     {profile.links.map((link:any)=>(
        <a key={link.id} href={link.url} target="_blank" rel="noopener noreferrer" className="w-full flex justify-center items-center bg-gray-200 hover:bg-gray-300 text-black font-semibold py-2 px-4 rounded mt-2 mb-2">
          {link.title}
        </a>
      ))
     ))}
